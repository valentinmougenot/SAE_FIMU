...
export const deleteByIdArtiste = (req, res) => {
    ...
    if (req.session.role !== "Administrateur") {
        res.status(401).send({
            message: "Vous devez être administrateur pour supprimer un lien entre le prochain artiste et un genre"
        });
        return;
    }
...
export const deleteAll = (req, res) => {
    ...
    if (req.session.role !== "Administrateur") {
        res.status(401).send({
            message: "Vous devez être administrateur pour supprimer tous les liens entre le prochain artiste et un genre"
        });
        return;
    }
