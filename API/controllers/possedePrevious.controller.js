...
const Possede = db.possedePrevious;
...
export const update = (req, res) => {
 ...
 export const deleteByIdArtiste = (req, res) => {
    ...
    if (req.session.role !== "Administrateur") {
        res.status(401).send({
            message: "Vous devez être administrateur pour supprimer un ancien lien entre un réseau social et un artiste"
        });
        return;
    }
 ...
 export const deleteAll =(req, res) => {
    ...
    if (req.session.role !== "Administrateur") {
        res.status(401).send({
            message: "Vous devez être administrateur pour supprimer tous les anciens liens entre un réseau social et un artiste"
        });
        return;
    }
