...
export const findOne = (req, res) => {
    ...
    Artiste.findByPk(id, {include: [{model:db.nationalitePrevious,
        include: [{model:db.pays}]},
        {model:db.faitPrevious,
            include: [{model:db.genre}]},
        {model:db.categorie}]})
        .then(data => {
            res.send(data);
...
export const findByYear = (req, res) => {
    ...
    Artiste.findAll({include: [{model:db.jouePrevious, where: {annee: year}},
        {model:db.nationalitePrevious,
            include: [{model:db.pays}]},
        {model:db.faitPrevious,
            include: [{model:db.genre}]},
        {model:db.categorie}]})
